...
namespace SessionSoftTimer
{
    ...
    {
        private static readonly string connectionString = "Data Source=10.1.32.252,1433;Network Library=DBMSSOCN;Initial Catalog=kiosk;User ID=sessionmanager;Password=RPLMpw2018;";
